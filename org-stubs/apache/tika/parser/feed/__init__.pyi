...
class FeedParser(org.apache.tika.parser.Parser):
    def __init__(self): ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("org.apache.tika.parser.feed")``.

    FeedParser: typing.Type[FeedParser]
