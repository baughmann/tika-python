...
class RFC822Parser(org.apache.tika.parser.Parser):
    def __init__(self): ...
    ...
    def setExtractAllAlternatives(self, boolean: bool) -> None: ...


class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("org.apache.tika.parser.mail")``.

    RFC822Parser: typing.Type[RFC822Parser]
