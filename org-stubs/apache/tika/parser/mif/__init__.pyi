...
class MIFContentHandler(org.xml.sax.helpers.DefaultHandler):
...
class MIFParser(org.apache.tika.parser.AbstractEncodingDetectorParser):
    @typing.overload
    def __init__(self): ...
    @typing.overload
    def __init__(self, encodingDetector: typing.Union[org.apache.tika.detect.EncodingDetector, typing.Callable]): ...
    def getContentHandler(self, contentHandler: org.xml.sax.ContentHandler, metadata: org.apache.tika.metadata.Metadata) -> org.xml.sax.ContentHandler: ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("org.apache.tika.parser.mif")``.

    MIFContentHandler: typing.Type[MIFContentHandler]
    MIFExtractor: typing.Type[MIFExtractor]
    MIFParser: typing.Type[MIFParser]
