...
class Word2006MLParser(org.apache.tika.parser.microsoft.AbstractOfficeParser):
    def __init__(self): ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("org.apache.tika.parser.microsoft.ooxml.xwpf.ml2006")``.

    Word2006MLParser: typing.Type[Word2006MLParser]
