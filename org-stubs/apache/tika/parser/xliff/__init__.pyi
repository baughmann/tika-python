...
class XLIFF12ContentHandler(org.xml.sax.helpers.DefaultHandler):
...
class XLIFF12Parser(org.apache.tika.parser.Parser):
    def __init__(self): ...
...
class XLZParser(org.apache.tika.parser.Parser):
    def __init__(self): ...
    def getSupportedTypes(self, parseContext: org.apache.tika.parser.ParseContext) -> java.util.Set[org.apache.tika.mime.MediaType]: ...
    def parse(self, inputStream: java.io.InputStream, contentHandler: org.xml.sax.ContentHandler, metadata: org.apache.tika.metadata.Metadata, parseContext: org.apache.tika.parser.ParseContext) -> None: ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("org.apache.tika.parser.xliff")``.

    XLIFF12ContentHandler: typing.Type[XLIFF12ContentHandler]
    XLIFF12Parser: typing.Type[XLIFF12Parser]
    XLZParser: typing.Type[XLZParser]
