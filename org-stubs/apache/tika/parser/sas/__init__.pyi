...
class SAS7BDATParser(org.apache.tika.parser.Parser):
    def __init__(self): ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("org.apache.tika.parser.sas")``.

    SAS7BDATParser: typing.Type[SAS7BDATParser]
