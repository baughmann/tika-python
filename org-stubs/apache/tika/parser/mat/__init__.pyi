...
class MatParser(org.apache.tika.parser.Parser):
    MATLAB_MIME_TYPE: typing.ClassVar[str] = ...
    def __init__(self): ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("org.apache.tika.parser.mat")``.

    MatParser: typing.Type[MatParser]
