...
class TMXContentHandler(org.xml.sax.helpers.DefaultHandler):
...
class TMXParser(org.apache.tika.parser.Parser):
    def __init__(self): ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("org.apache.tika.parser.tmx")``.

    TMXContentHandler: typing.Type[TMXContentHandler]
    TMXParser: typing.Type[TMXParser]
